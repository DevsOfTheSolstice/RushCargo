INSERT into vehicles (vin_vehicle, brand, model, weight_capacity, width_capacity, height_capacity, length_capacity, vehicle_type)
...
INSERT INTO drivers (username, born_date, first_name, last_name, salary, id_document)
VALUES ('yukari', '1998-05-01', 'Yukari', 'Tanizaki', 99.0, 2);

INSERT INTO motorcyclists (username, motorcycle, affiliated_branch)
