...
GRAPH_CITY_MAIN_WAREHOUSE_NODE_SIZE = 600
GRAPH_CITY_WAREHOUSE_NODE_COLOR = "#c3fae8"
GRAPH_CITY_WAREHOUSE_NODE_SIZE = 300

# ... for Warehouse-related Edges
GRAPH_MAIN_REGION_WAREHOUSE_EDGE_COLOR = "#212529"
GRAPH_MAIN_REGION_WAREHOUSE_WIDTH = 8
GRAPH_MAIN_CITY_WAREHOUSE_EDGE_COLOR = "grey"
GRAPH_MAIN_CITY_WAREHOUSE_WIDTH = 4
